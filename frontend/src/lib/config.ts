...
export const CONTRACTS = {
  registry: (process.env.NEXT_PUBLIC_CONTRACT_ADDRESS_REGISTRY || "0x0000000000000000000000000000000000000000") as Address,
  marketplace: (process.env.NEXT_PUBLIC_CONTRACT_ADDRESS_MARKETPLACE || "0x0000000000000000000000000000000000000000") as Address,
  access: (process.env.NEXT_PUBLIC_CONTRACT_ADDRESS_ACCESS || "0x0000000000000000000000000000000000000000") as Address
};
